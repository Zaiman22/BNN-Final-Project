...
//Date        : Tue Oct  7 21:49:25 2025
//Host        : pop-os running 64-bit Pop!_OS 22.04 LTS
//Command     : generate_target BiTRIM_integraion.bd
//Design      : BiTRIM_integraion
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "BiTRIM_integraion,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BiTRIM_integraion,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_clkrst_cnt=3,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "BiTRIM_integraion.hwdef" *) 
module BiTRIM_integraion
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  BiTRIM_integraion_XNOR_CONV_PE_0_0 XNOR_CONV_PE_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .en(1'b0),
        .inbottom(1'b0),
        .inside(1'b0),
        .intop(1'b0),
        .pcountin({1'b0,1'b0,1'b0,1'b0}),
        ...
        .weight_control(1'b0),
        .weight_in(1'b0));
  BiTRIM_integraion_axi_dma_0_0 axi_dma_0
  ...
  BiTRIM_integraion_axi_smc_0 axi_smc
  ...
  BiTRIM_integraion_axis_data_fifo_0_0 axis_data_fifo_0
  ...
  BiTRIM_integraion_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
        ...
        .S_AXI_HP2_ARADDR(axi_smc_M02_AXI_ARADDR),
        .S_AXI_HP2_ARBURST(axi_smc_M02_AXI_ARBURST),
        .S_AXI_HP2_ARCACHE(axi_smc_M02_AXI_ARCACHE),
        .S_AXI_HP2_ARID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP2_ARLEN(axi_smc_M02_AXI_ARLEN),
        .S_AXI_HP2_ARLOCK(axi_smc_M02_AXI_ARLOCK),
        .S_AXI_HP2_ARPROT(axi_smc_M02_AXI_ARPROT),
        .S_AXI_HP2_ARQOS(axi_smc_M02_AXI_ARQOS),
        .S_AXI_HP2_ARREADY(axi_smc_M02_AXI_ARREADY),
        .S_AXI_HP2_ARSIZE(axi_smc_M02_AXI_ARSIZE),
        .S_AXI_HP2_ARVALID(axi_smc_M02_AXI_ARVALID),
        .S_AXI_HP2_AWADDR(axi_smc_M02_AXI_AWADDR),
        .S_AXI_HP2_AWBURST(axi_smc_M02_AXI_AWBURST),
        .S_AXI_HP2_AWCACHE(axi_smc_M02_AXI_AWCACHE),
        .S_AXI_HP2_AWID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP2_AWLEN(axi_smc_M02_AXI_AWLEN),
        .S_AXI_HP2_AWLOCK(axi_smc_M02_AXI_AWLOCK),
        .S_AXI_HP2_AWPROT(axi_smc_M02_AXI_AWPROT),
        .S_AXI_HP2_AWQOS(axi_smc_M02_AXI_AWQOS),
        .S_AXI_HP2_AWREADY(axi_smc_M02_AXI_AWREADY),
        .S_AXI_HP2_AWSIZE(axi_smc_M02_AXI_AWSIZE),
        .S_AXI_HP2_AWVALID(axi_smc_M02_AXI_AWVALID),
        .S_AXI_HP2_BREADY(axi_smc_M02_AXI_BREADY),
        .S_AXI_HP2_BRESP(axi_smc_M02_AXI_BRESP),
        .S_AXI_HP2_BVALID(axi_smc_M02_AXI_BVALID),
        .S_AXI_HP2_RDATA(axi_smc_M02_AXI_RDATA),
        .S_AXI_HP2_RDISSUECAP1_EN(1'b0),
        .S_AXI_HP2_RLAST(axi_smc_M02_AXI_RLAST),
        .S_AXI_HP2_RREADY(axi_smc_M02_AXI_RREADY),
        .S_AXI_HP2_RRESP(axi_smc_M02_AXI_RRESP),
        .S_AXI_HP2_RVALID(axi_smc_M02_AXI_RVALID),
        .S_AXI_HP2_WDATA(axi_smc_M02_AXI_WDATA),
        .S_AXI_HP2_WID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP2_WLAST(axi_smc_M02_AXI_WLAST),
        .S_AXI_HP2_WREADY(axi_smc_M02_AXI_WREADY),
        .S_AXI_HP2_WRISSUECAP1_EN(1'b0),
        .S_AXI_HP2_WSTRB(axi_smc_M02_AXI_WSTRB),
        .S_AXI_HP2_WVALID(axi_smc_M02_AXI_WVALID),
        .USB0_VBUS_PWRFAULT(1'b0));
  BiTRIM_integraion_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
